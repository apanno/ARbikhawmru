    ...
    SampleApplicationControl, SampleAppMenuInterface
{
    ...
    public static final int KING8KING9 = 1;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mMovieName[RELIGIOUS] = "VideoPlayback/religious.mp4";
        mMovieName[KING8KING9] = "VideoPlayback/king8king9.mp4";
    ...
    public boolean doLoadTrackersData()
    {
        ...
        dataSetrama9 = objectTracker.createDataSet();
        if (dataSetrama9 == null)
        {
        ...
        // Load the data sets:
        if (!dataSetrama9.load("rama9.xml",
        ...
        if (!objectTracker.activateDataSet(dataSetrama9))
        {
    ...
    public boolean doUnloadTrackersData()
    {
        ...
        if (dataSetrama9 != null)
        {
            if (objectTracker.getActiveDataSet(0) == dataSetrama9
                && !objectTracker.deactivateDataSet(dataSetrama9))
            {
                Log.d(
                    LOGTAG,
                    "Failed to destroy the tracking data set rama9 because the data set could not be deactivated.");
                result = false;
            } else if (!objectTracker.destroyDataSet(dataSetrama9))
            {
                Log.d(LOGTAG,
                    "Failed to destroy the tracking data set rama9.");
                result = false;
            }
